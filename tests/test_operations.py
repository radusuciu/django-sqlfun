...
def test_operation_arguments_are_visible_to_the_migration_writer(operation_cls):
    ...
    # django.utils.inspect.get_func_args reports; anything it misses is
    # silently left out of the written migration
    from django.utils.inspect import get_func_args

    parameters = inspect.signature(operation_cls.__init__).parameters
    assert get_func_args(operation_cls.__init__) == list(parameters)
